  ...
  function plugins() {
    return src([
      ...
      'app/js/plugins/jquery.suggestions.js',
  ...
  function scripts() {
    return src([ // Берем файлы из источников
      'app/js/scripts/helpers.js',
      'app/js/scripts/script.js', // Пользовательские скрипты, использующие библиотеку, должны быть подключены в конце
      ])
  ...
  function cleanProject() {
    return src(['dist','app/css','app/js/app.min.js','app/js/plugins.min.js'], {allowEmpty: true}).pipe(clean());
  }
  ...
  exports.build = series(cleandist, styles, plugins, scripts, images, buildcopy);
  exports.prod = series(cleandist, stylesMin, plugins, scriptsMin, images, buildcopy, htmlMin);
